     ...
     module TSOS {
        ...
        export class Kernel {
            ...
            public krnBootstrap() {      // Page 8. {
                ...
                _NewProcess = new Queue(); //new processes that are loaded
                _RunningProcess = new Queue(); //processes that will run
            ...
            public completeProg(program){
                ...
                Control.clearPcbTable(_CpuScheduler.program.pid);
